...
@endif
<form action=" {{route('register')}}" class="w-3/6 h-4/6 @if(empty($banner)) mt-28 @endif text-center m-auto p-10 opacity-100" method="POST">
    @csrf
    ...
    <div class="relative h-14 z-0 mb-5 w-full">
        ...
        <label id="label" for=""
               class="absolute m-auto top-6 right-0  left-0 text-gray-500 -z-10 transform peer-focus:text-rose-600 peer-focus:top-0 peer-valid:text-rose-600 peer-valid:top-0 peer-valid:text-sm peer-focus:text-xs duration-300">Confirm</label>
